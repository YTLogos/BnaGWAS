        ...
        tabItem(
          ...
          fluidRow(
            shinydashboard::box(
              ...
              fileInput(ns("phenotype"),
                label = "Upload Your Phenotype File (Leave blank for example run).",
                accept = c(
                  "text/plain",
          ...
          fluidRow(
            shinydashboard::box(
              ...
              withSpinner(plotOutput(ns("phenotype_vis")), type = "4")
            ),
            shinydashboard::box(
              status = "warning",
              title = strong("Result of GWAS"),
              solidHeader = TRUE,
              withSpinner(DT::dataTableOutput(ns("gwas_res")), type = "6"),
              br(),
              br(),
        ...
        tabItem(
          ...
          fluidRow(
            ...
            shinydashboard::box(
              ...
              width = 12,
              solidHeader = TRUE,
              withSpinner(plotOutput(ns("manhattanplot")), type = "6"),
          ...
          fluidRow(
            shinydashboard::box(
              ...
              width = 5,
              solidHeader = TRUE,
              withSpinner(plotOutput(ns("qq_plot")), type = "6"),
        ...
        tabItem(
          ...
          fluidRow(
            ...
            shinydashboard::box(
              ...
              width = 12,
              solidHeader = TRUE,
              withSpinner(DT::dataTableOutput(ns("related_genes")), type = "7"),
              br(),
        ...
        tabItem(
          ...
          fluidRow(
            shinydashboard::box(
              ...
              width = 12,
              solidHeader = TRUE,
              withSpinner(DT::dataTableOutput(ns("gene_annotation")), type = "7"),
